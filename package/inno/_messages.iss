...
en.extDOCXF =Euro-Office Form Template
en_GB.extDOCXF =Euro-Office Form Template
ar_SA.extDOCXF =قالب استبيان Euro-Office
bg.extDOCXF =Euro-Office Шаблон на формуляр
ca.extDOCXF =Plantilla de formulari Euro-Office
cs.extDOCXF =Šablona formuláře Euro-Office
el.extDOCXF =Πρότυπο φόρμας εγγράφου Euro-Office
;et.extDOCXF =Euro-Office dokumendi vormi mall
fi.extDOCXF =Euro-Office-asiakirjalomakemalli
;lt.extDOCXF =Euro-Office Anketos Šablonas
lo.extDOCXF =ຮູບແບບຂອງ Euro-Office
nl.extDOCXF =Euro-Office Formulier Sjabloon
ru.extDOCXF =Шаблон формы Euro-Office
de.extDOCXF =Euro-Office-Formularvorlage
fr.extDOCXF =Modèle de formulaire Euro-Office
es.extDOCXF =Plantilla de formulario Euro-Office
id.extDOCXF =Templat Euro-Office Form
it_IT.extDOCXF =Modello di modulo Euro-Office
pt_BR.extDOCXF =Modelo de formulário do Euro-Office
pt_PT.extDOCXF =Modelo de formulário Euro-Office
pl.extDOCXF =Szablon formularza Euro-Office
ro.extDOCXF =Șablon Formă Euro-Office
sk.extDOCXF =Šablóna formulára Euro-Office
sl.extDOCXF =Euro-Office predloga obrazca
sv.extDOCXF =Euro-Office formulärmall
tr.extDOCXF =Euro-Office Belgesi Form Şablonu
vi.extDOCXF =Mẫu biểu mẫu tài liệu Euro-Office
zh_CN.extDOCXF =Euro-Office表单模板
hy_AM.extDOCXF =Euro-Office փաստաթղթի ձևանմուշ
;hr.extDOCXF =Euro-Office Predložak obrasca
da.extDOCXF =Euro-Office formularskabelon
;hi.extDOCXF =ओनलीऑफिस दस्तावेज़ फॉर्म टेम्पलेट
hu.extDOCXF =Euro-Office formátum-sablon
;ga_IE.extDOCXF =Teimpléad Foirm Euro-Office
ja.extDOCXF =Euro-Office フォーム テンプレート
ko.extDOCXF =Euro-Office 문서 양식 템플릿
lv.extDOCXF =Euro-Office veidlapas veidne
no.extDOCXF =Euro-Office-dokumentskjemamal
uk.extDOCXF =Шаблон форми Euro-Office
be.extDOCXF =Шаблон формы Euro-Office
gl.extDOCXF =Euro-Office Modelo de Formulario
si.extDOCXF =ඔන්ලිඔෆිස් ආකෘතිපත්‍ර අච්චුව
zh_TW.extDOCXF =Euro-Office 文档表单模板
sr_Cyrl_RS.extDOCXF =Euro-Office формулар шаблон
sr_Latn_RS.extDOCXF =Euro-Office formular šablon
he.extDOCXF =תבנית טופס Euro-Office
sq.extDOCXF =Modeli i shablloni Euro-Office
#if Ver >= EncodeVer(6,1,1)
ur.extDOCXF =Euro-Office فارم ٹیمپلیٹ
#endif
